...
import { useGetPurchaseListQuery } from '../../features/salesService/SalesApi'
...
const SalesList = () => {
  ...
  const { data, isLoading, error } = useGetPurchaseListQuery({})
  console.log(data);
    ...
    <Box>
      ...
      <Box display={"flex"} justifyContent={"space-between"}>
        ...
        <Box display={'flex'} >
          ...
          <Button onClick={() => navigate("new-sale")} variant="contained" sx={{ bgcolor: "#014", width: 150, height: 55 }}>
            New Sale
          </Button>
        </Box>
      </Box>

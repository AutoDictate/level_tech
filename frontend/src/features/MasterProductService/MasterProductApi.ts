...
export const masterProductsApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getMasterProductList: builder.mutation({
      query: (credentials) => ({
...
export const { useGetAllMasterProductQuery, useGetMasterProductListMutation, useGetMasterProductByIdMutation, usePostMasterProductDataMutation, useUpdateMasterProductListWithOptionsMutation, useDeleteMasterProductMutation } = masterProductsApi;
